export default function MyComponent() {
  return (
    <div className="flex flex-col items-start py-16 pr-20 pl-8 bg-white max-w-[810px] max-md:px-5">
      ...
      <div className="mt-8 text-3xl font-semibold leading-8 text-neutral-800 max-md:max-w-full">
        Roadmap
      </div>
      <div className="mt-4 text-base leading-5 text-sky-400 max-md:max-w-full">
        What we're working on, and what we've accomplished in one tidy list. See
        the <span className="text-sky-400">Features</span> list
        <br />
      ...
      <div className="flex gap-1.5 justify-center mt-4 text-base font-bold leading-5 whitespace-nowrap text-neutral-800">
        ...
        <div className="flex gap-2.5 justify-center px-2.5 py-1 rounded bg-zinc-100">
          ...
          <img
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/e0af139b3c97d913f5765b753304b68d5553e6a816fdd869539f0f14aabd3248?"
      ...
      <div className="flex gap-0 mt-8 text-base leading-5 text-zinc-600 max-md:flex-wrap">
        ...
        <div className="flex flex-col grow shrink-0 pl-8 basis-0 w-fit max-md:max-w-full">
          <div className="text-xl font-bold leading-6 text-neutral-800 max-md:max-w-full">
            Work in Progress
          </div>
          ...
          <div className="mt-5 tracking-wide leading-5 max-md:max-w-full">
            Not big on surprises, huh? No worries, here's what we aim to launch
            in the next
            <br />
            few months:
          </div>
          <div className="flex flex-col pl-6 mt-5 tracking-wide max-md:pl-5 max-md:max-w-full">
            <div className="max-md:max-w-full">
              Auto-complete (sanp-to-sketching)
            </div>
            <div className="max-md:max-w-full">Apple Sign In support</div>
            <div className="max-md:max-w-full">Scale & Measurement</div>
            <div className="max-md:max-w-full">Text Tool</div>
            <div className="max-md:max-w-full">More keyboard shortcuts</div>
          </div>
          <div className="mt-5 tracking-wide max-md:max-w-full">
            Follow up reading:
          </div>
          <div className="flex flex-col pl-6 mt-5 tracking-wide text-sky-400 max-md:pl-5 max-md:max-w-full">
            <div className="max-md:max-w-full">
          ...
          <div className="mt-5 tracking-wide text-zinc-400 max-md:max-w-full">
            Read Less
          </div>
          ...
          <div className="mt-2 tracking-wide max-md:max-w-full">
          ...
          <div className="flex flex-col pl-6 mt-2 tracking-wide leading-5 max-md:pl-5 max-md:max-w-full">
            <div className="max-md:max-w-full">
              ...
              handles. Pull one
              <br />
              or two handles to adjust the aspect ratio, or tap one or two
              handles and pinch /<br />
              spread / pull to activate the more advanced transforms.
            </div>
            <div className="max-md:max-w-full">
          ...
          <div className="mt-2 mr-6 tracking-wide leading-5 text-sky-400 max-md:mr-2.5 max-md:max-w-full">
            For a deeper explanation, including pics + video examples, check out
            the full
            <br />
            <span className="text-sky-400">release post.</span>
          </div>
          <div className="mt-2 tracking-wide leading-5 text-sky-400 max-md:max-w-full">
            Submit your{" "}
